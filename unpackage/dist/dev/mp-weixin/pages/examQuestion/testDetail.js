  ...
  methods: {
    ...
    onClickLeft: function onClickLeft() {var _this = this;
      uni.showModal({
        ...
        cancelText: '不保存',
        confirmText: '保存',
        success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var date, currentTime, data, _yield$_this$request, _yield$_this$request2, errTest, resTest;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!
                    res.confirm) {_context.next = 13;break;}
                    date = new Date();
                    ...
                    data = {
                      ...
                      testId: _this.qid + 1,
                      date: currentTime };_context.next = 6;return (

                      _this.request({
                        url: "".concat(_this.SERVER, "/api/myTest/"),
                        method: 'post',
                        data: data }));case 6:_yield$_this$request = _context.sent;_yield$_this$request2 = _slicedToArray(_yield$_this$request, 2);errTest = _yield$_this$request2[0];resTest = _yield$_this$request2[1];
                    ...
                    }case 14:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}() });


    } },

  onLoad: function () {var _onLoad = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(option) {var _yield$this$request, _yield$this$request2, err, res, _yield$this$request3, _yield$this$request4, errColl, resColl;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
              ...
              _context2.next = 4;return this.request({
                ...
                method: 'get' });case 4:_yield$this$request = _context2.sent;_yield$this$request2 = _slicedToArray(_yield$this$request, 2);err = _yield$this$request2[0];res = _yield$this$request2[1];
              ...
              // 判断第一题是否收藏
              _context2.next = 12;return this.request({
                url: "".concat(this.SERVER, "/api/isCollection?userId=").concat(this.users.id, "&testId=").concat(this.topics[this.qid].id),
                method: 'get' });case 12:_yield$this$request3 = _context2.sent;_yield$this$request4 = _slicedToArray(_yield$this$request3, 2);errColl = _yield$this$request4[0];resColl = _yield$this$request4[1];
              ...
              }case 17:case "end":return _context2.stop();}}}, _callee2, this);}));function onLoad(_x2) {return _onLoad.apply(this, arguments);}return onLoad;}() };exports.default = _default;
